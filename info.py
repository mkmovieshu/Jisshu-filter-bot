...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'mkadmin_sir') # without @ or https://t.me/ 
USERNAME = environ.get('USERNAME', "mkadmin_sir") # ADMIN USERNAME

# Database Channel 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002344843738').split()]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1002388133823'))
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002388133823'))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002329914165'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002329914165')) 
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002329914165'))
...
# Other Channel's
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002388133823'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','0'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002287735468') 
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1001651228460')) 

# Added Link Here Not Id 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/mk_movie_request')
